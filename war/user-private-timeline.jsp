                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="active"><a href="user-private-timeline.jsp">Timeline</a>
                            </li>
        ...
        <nav class="navbar navbar-subnav navbar-static-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="subnav">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="user-private-timeline.jsp"><i class="fa fa-fw icon-ship-wheel"></i> My Timeline</a>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
...
&markers=color:red%7Clabel:C%7C40.718217,-73.998284" class="img-responsive">
                   ...
                   <a href=""><i class="fa fa-photo"></i></a>
                        ...
                        <li class="media" id="september">
                            <div class="pull-left">
                                <img src="images/people/110/guy-5.jpg" alt="people" class="img-circle" width="80" />
                                <div class="date">31 SEP</div>
                            </div>
                            <div class="media-body">
                                <div class="panel panel-default">
                                    <div class="panel-body">
